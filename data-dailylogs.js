...
const dailyLogs = {
  ...
  // ... (keep all previous entries here as needed)
  ...
  "2025-12-31": { 
    bloodPressure: [
      ...
      { systolic: 132, diastolic: 73, heartRate: 86 },  // treadmill
      { systolic: 128, diastolic: 68, heartRate: 85 }   // second post-exercise BP
    ],
    glucose: [{ value: 5.4 }],
    walk: 5,
    treadmill: 10,
    strength: 16,
    calories: 12,
    heartRate: 141  // average from treadmill
  }
};
